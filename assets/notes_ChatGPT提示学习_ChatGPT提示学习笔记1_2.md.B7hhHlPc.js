...
</code></pre><p>目前解决这个瞎编不存在的事物的问题的方案：要求模型首先从文本中找到任何相关的引用，然后要求它使用这些引用来回答问题，并且可以追溯答案回源文档，来帮助减少这些“幻觉”</p>`,75)]))}const g=i(p,[["render",l]]);export{F as __pageData,g as default};
