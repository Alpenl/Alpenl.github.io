...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    }</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><h2 id="as-name" tabindex="-1">as name <a class="header-anchor" href="#as-name" aria-label="Permalink to &quot;as name&quot;">​</a></h2><div class="language-JavaScript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">JavaScript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {symbol1 </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">as</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> alias, symbol2} </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;filename&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span></code></pre></div><h2 id="create2" tabindex="-1">create2 <a class="header-anchor" href="#create2" aria-label="Permalink to &quot;create2&quot;">​</a></h2><p>原来我们使用<code>create2</code>是使用内联汇编的形式： <img src="https://oss.justin3go.com/blogs/Pasted%20image%2020220615201958.png" alt=""> 以前需部署的时候才能知道这个地址，而现在可以使用这个盐(salt)</p>`,14)]))}const g=i(p,[["render",h]]);export{c as __pageData,g as default};
